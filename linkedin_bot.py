...
_IMAGE_STYLE_TEMPLATE = (
    "Photograph. A real photograph taken this week with a full-frame digital "
    "camera. NOT an illustration. NOT a 3D render. NOT CGI. NOT digital art. "
    ...
    "Do not include: trademarked machine designs, identifiable branded products, "
    "specific named equipment — only generic category equipment. "
